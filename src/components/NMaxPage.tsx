...
export function NMaxPage({ onSubmit }: ContactFormProps) {
  ...
  const showcaseData = {
    ...
    productDescription:
      "Offers the highest analysis of organically sourced nitrogen in liquid form. Provides an immediate and lasting boost to both protected and outdoor crops by maximizing green leaf area and enhancing vegetative growth. Derived from approved molasses and plant protein sources, it is a safe and effective nutrient solution for organic cropping systems.",
    keyFeatures: [
  ...
  return (
    <div className="min-h-screen mt-10 bg-[#ececec]">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div {...fadeInUp}>
              ...
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                Offers the highest analysis of organically sourced nitrogen in
                liquid form. Provides an immediate and lasting boost to both
                protected and outdoor crops by maximizing green leaf area and
                enhancing vegetative growth. Perfect for crops requiring
                vigorous nitrogen nutrition.
              </p>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Derived from approved molasses and plant protein sources, it is
                a safe and effective nutrient solution for organic cropping
                systems. Fully approved and certified for use in organic
                cropping systems in the UK by the Soil Association.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <motion.div className="text-center mb-16" variants={fadeInUp}>
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover why N-Max (7-2-2) delivers the highest nitrogen nutrition
              for organic systems
            </p>
          </motion.div>
      ...
      <AnalysisPieChart
        ...
        title="N-Max (7-2-2) Maximum Nitrogen Analysis"
      />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-6">
              Maximum Nitrogen Technology
            </h2>
            <p className="text-xl text-gray-600">
              Highest analysis organically sourced nitrogen for exceptional
              vegetative growth
            </p>
          </div>
      ...
      <motion.section
        ...
        viewport={{ once: true }}
      >
        <div id="application-guidelines-nmaxpage" className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-6">Application Benefits</h2>
            <p className="text-xl text-gray-600">
              Immediate and lasting boost for both protected and outdoor crop
              systems
            </p>
          </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[#6abf4b]">
                      ...
                      potential in both protected and outdoor systems while
                      maintaining full organic certification compliance.
                    </p>
                  </div>
                </div>
              </CardContent>
      ...
      {/* PDF Links Section */}
      <PDFLinks
        id="technical-resources-nmaxpage"
        productName="N-Max (7-2-2)"
        links={pdfLinks}
      />
