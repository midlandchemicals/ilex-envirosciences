...
import img from "../../public/start-up-max-img.jpg";
  ...
  const pdfLinks = [
    {
      ...
      url: "https://margdwcgeanpawjvnvqf.supabase.co/storage/v1/object/public/Ilex/startup-max/Start-uP-MAXX-1810-i.pdf",
    },
    {
      title: "Phosphite Action Information Sheet",
      description: "Technical information about phosphite mode of action",
      url: "https://margdwcgeanpawjvnvqf.supabase.co/storage/v1/object/public/Ilex/startup-max/phosphites-1701-iv.pdf",
    },
    {
      title: "Compatibility Chart",
      description: "Tank mixing compatibility with other seed treatments",
      url: "https://margdwcgeanpawjvnvqf.supabase.co/storage/v1/object/public/Ilex/startup-max/Compatibility-Chart-0923-ii.pdf",
    },
  ];
