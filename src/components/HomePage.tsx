  ...
  const productRanges = [
    {
      ...
      description: "Advanced phosphite-based nutrients for enhanced plant health and disease resistance",
    ...
    },
    {
      ...
      description: "High-quality foliar nutrients for optimal crop nutrition and performance",
    ...
    },
    {
      ...
      description: "Essential calcium products for improved crop quality and storage",
    ...
    {
      title: "Biostimulants",
      description: "Natural biostimulants to enhance plant growth and stress tolerance",
      icon: <Leaf className="h-8 w-8 text-emerald-600" />,
      link: "biostimulants",
      gradient: "from-emerald-500 to-teal-600",
      productCount: 2,
      image: "https://images.unsplash.com/photo-1609252847389-15ce22b37f65?w=400&h=300&fit=crop"
    },
    {
      title: "Seed Treatments",
      description: "Specialized treatments for superior seed germination and early growth",
    ...
    {
      title: "Organic Range",
      description: "Certified organic products for sustainable agriculture practices",
  ...
  const features = [
    {
      ...
      description: "Our advanced formulations deliver nutrients quickly and efficiently to your crops"
    },
    {
      icon: <Target className="h-12 w-12 text-green-600" />,
      title: "Precision Agriculture",
      description: "Targeted solutions for specific crop needs and growth stages"
    },
    {
      icon: <Heart className="h-12 w-12 text-red-600" />,
      title: "Sustainable Solutions",
      description: "Environmentally responsible products that support long-term soil health"
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          <motion.div {...fadeInUp}>
            ...
            <p className="text-2xl text-gray-600 mb-8 max-w-4xl mx-auto leading-relaxed">
              Pioneering foliar nutrition solutions that deliver superior crop performance, 
        ...
        <div className="max-w-7xl mx-auto">
          <motion.div className="text-center mb-16" variants={fadeInUp}>
            ...
            <p className="text-2xl text-gray-600 max-w-4xl mx-auto">
              Comprehensive nutrition solutions designed for every stage of crop development
            </p>
          </motion.div>
              ...
              <motion.div key={index} variants={fadeInUp}>
                <Card className="h-full hover:shadow-2xl transition-all duration-500 border-0 bg-white/70 backdrop-blur-sm group overflow-hidden">
                  <div className="relative">
                    ...
                    />
                    <div className={`absolute inset-0 bg-gradient-to-t ${range.gradient} opacity-20 group-hover:opacity-30 transition-opacity duration-500`} />
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Get expert advice on the best nutrition solutions for your specific needs
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Button 
              size="lg" 
