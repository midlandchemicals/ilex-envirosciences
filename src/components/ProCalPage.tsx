...
export function ProCalPage({ onSubmit }: ContactFormProps) {
  ...
  const benefits = [
    {
      ...
      description: "Maximises calcium uptake through advanced formulation technology"
    },
    {
      icon: <Heart className="h-8 w-8 text-green-600" />,
      title: "Promotes Root Growth & Plant Health",
      description: "Strong root system development leading to healthier crops throughout growth cycle"
    },
    {
      icon: <Sparkles className="h-8 w-8 text-purple-600" />,
      title: "Improves Appearance & Marketability",
      description: "Enhanced color, appearance and overall crop quality for better market value"
    },
    {
      icon: <Shield className="h-8 w-8 text-orange-600" />,
      title: "Increases Storage Quality",
      description: "Better storage characteristics extending shelf life and reducing post-harvest losses"
    },
    {
      icon: <Droplets className="h-8 w-8 text-cyan-600" />,
      title: "Easy to Use Liquid",
      description: "Good tank mix compatibility with convenient liquid formulation"
    },
    {
      icon: <Award className="h-8 w-8 text-yellow-600" />,
      title: "Advanced Formulation",
      description: "Stabilised nitrogen with plant-available calcium and essential micronutrients"
    }
  ];
  ...
  const crops = [
    {
      name: "Brassicas",
      rate: "5.0-10.0 l/ha",
      timing: "Apply from 4-6 true leaves. Repeat at 14-21 day intervals up to harvest",
      color: "bg-green-100 text-green-800"
    },
    {
      name: "Carrots",
      rate: "5.0-10.0 l/ha",
      timing: "Apply from 4-6 true leaves. Repeat at 14-21 day intervals up to strawing",
    ...
    },
    {
      ...
      rate: "3.0-6.0 l/ha",
      timing: "Apply from 4-6 true leaves. Repeat at 10-14 day intervals up to harvest",
      color: "bg-emerald-100 text-emerald-800"
    },
    {
      name: "Potatoes",
      rate: "5.0 l/ha",
      timing: "Apply from start of tuber bulking. Repeat @ 5.0 l/ha during tuber bulking",
      color: "bg-amber-100 text-amber-800"
    },
    {
      name: "Cereals",
      rate: "5.0-10.0 l/ha",
      timing: "Apply at growth Stages (Zadoks) 23-30, 39-45 and 50-59. For milling wheat: additional 30-50 l/ha at GS 69-75",
  ...
  const showcaseData = {
    productName: "Pro-Cal™",
    productDescription: "Pro-Cal™ is a new form of foliar nutrient combining stabilised nitrogen with plant-available calcium, together with essential micronutrients. Pro-Cal™ can be used to benefit a wide range of horticultural and vegetable crops. Timed applications at important growth stages will promote an initial strong root system before helping maintain the healthy development of the crop through to harvest.",
    keyFeatures: [
    ...
    scientificBenefits: [
      {
        ...
        description: "Advanced nitrogen formulation provides sustained nutrient release for optimal plant uptake",
        icon: <Zap className="h-6 w-6 text-blue-600" />
      },
      {
        title: "Plant-Available Calcium",
        description: "Highly bioavailable calcium form for enhanced cell wall strength and fruit quality",
        icon: <Target className="h-6 w-6 text-green-600" />
      },
      {
        title: "Essential Micronutrients",
        description: "Complete micronutrient package supports enzyme functions and plant metabolism",
        icon: <Beaker className="h-6 w-6 text-purple-600" />
      },
      {
        title: "Root Development",
        description: "Promotes strong root system establishment for improved nutrient and water uptake",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div {...fadeInUp}>
              ...
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                Pro-Cal™ is a new form of foliar nutrient combining stabilised nitrogen with plant-available 
                calcium, together with essential micronutrients.
              </p>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Pro-Cal™ can be used to benefit a wide range of horticultural and vegetable crops. Timed applications 
                at important growth stages will promote an initial strong root system before helping maintain the 
                healthy development of the crop through to harvest.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <motion.div className="text-center mb-16" variants={fadeInUp}>
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover why Pro-Cal™ is the optimal choice for horticultural and vegetable crop nutrition
            </p>
          </motion.div>
      ...
      {/* Analysis Pie Chart */}
      <AnalysisPieChart analysis={analysisData} title="Pro-Cal™ Advanced Formulation Analysis" />
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-6">Advanced Formulation Technology</h2>
              ...
              <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl">
                <CardContent className="p-8">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-2xl font-semibold">Advanced Formulation</h3>
                  </div>
                  <div className="space-y-6">
                    <div className="flex justify-between items-center p-4 bg-blue-50 rounded-lg">
                      <span className="text-gray-700 font-medium">Stabilised Nitrogen</span>
                      <Badge variant="secondary" className="text-lg px-3 py-1">Enhanced Uptake</Badge>
                    </div>
                    
                    <div className="flex justify-between items-center p-4 bg-green-50 rounded-lg">
                      <span className="text-gray-700 font-medium">Plant-Available Calcium</span>
                      <Badge variant="secondary" className="text-lg px-3 py-1">Optimised Form</Badge>
                    </div>
                    
                    <div className="flex justify-between items-center p-4 bg-purple-50 rounded-lg">
                      <span className="text-gray-700 font-medium">Essential Micronutrients</span>
                      <Badge variant="secondary" className="text-lg px-3 py-1">Complete Package</Badge>
                    </div>
                    
                    <div className="bg-gradient-to-r from-blue-50 to-green-50 rounded-lg p-4">
                      <h4 className="font-semibold text-blue-800 mb-2">Crop Benefits</h4>
                      <div className="grid grid-cols-1 gap-2">
                        <div className="flex items-center gap-2">
                          <CheckCircle className="h-4 w-4 text-green-600" />
                          <span className="text-sm text-gray-700">Strong root system development</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <CheckCircle className="h-4 w-4 text-green-600" />
                          <span className="text-sm text-gray-700">Enhanced crop appearance & color</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <CheckCircle className="h-4 w-4 text-green-600" />
                          <span className="text-sm text-gray-700">Improved storage quality</span>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Tailored application guidelines for horticultural and vegetable crops
            </p>
          </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-700">
                      Pro-Cal is best applied as a foliar spray at water rates of between 200-600 l/ha 
                      depending on the crop type, stage of growth and amount of leaf area.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="bg-amber-50 border border-amber-200">
              <CardContent className="p-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-2 text-amber-800">Important Safety Note</h3>
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
              <CardContent className="p-8">
                ...
                <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-green-50 rounded-lg">
                  ...
                  <p className="text-gray-600">Professional foliar nutrition for horticultural and vegetable crops</p>
                </div>
              </CardContent>
            </Card>
          </div>
      ...
      {/* PDF Links Section */}
      <PDFLinks productName="Pro-Cal™" links={pdfLinks} />
