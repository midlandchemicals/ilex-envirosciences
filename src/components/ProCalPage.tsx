...
import img from "../../public/Pro-cal-img.jpg";
  ...
  const pdfLinks = [
    {
      ...
      url: "https://margdwcgeanpawjvnvqf.supabase.co/storage/v1/object/public/Ilex/pro-cal/Pro-Cal-Veg-1606-i.pdf",
    },
    {
      title: "Compatibility Chart",
      description: "Tank mixing compatibility with other agricultural products",
      url: "https://margdwcgeanpawjvnvqf.supabase.co/storage/v1/object/public/Ilex/pro-cal/Compatibility-Chart-0923-ii.pdf",
    },
  ];
