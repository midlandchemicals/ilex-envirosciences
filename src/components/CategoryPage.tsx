...
export function CategoryPage({ category, onPageChange }: CategoryPageProps) {
  ...
  const getManualProductDescription = (productName: string): string => {
    ...
    const descriptionMap: { [key: string]: string } = {
      // Phosphite Range
      "Crop Rooter® Plus":
        "Our premium next generation NPK phosphite, formulated with 19 amino acids to target root development and stimulate healthy plant growth.",
      "PK MAXX™ +":
        "A powerful multi-nutrient phosphite crop nutrient formulated to boost root and shoot development and stimulate healthy growth.",
      "OilSeed Raiser™":
        "Oilseed Raiser™ is a nutritional supplement with phosphite- powered delivery designed to encourage oilseed rape crops to reach their full potential.",
      "Tensile™":
        "Combining silicon and potassium with phosphite P and seaweed-derived natural biostimulants, formulated to improve crop strength, quality and shelf life.",
      "Beet Raiser™":
        "Formulated to boost root development, nutrient uptake and stress resistance, Beet Raiser helps sugar beet crops achieve their full potential.",
      "Maniphos™":
        "Maniphos™ helps to prevent Manganese and Sulphur deficiencies. The zero nitrogen formulation makes it an ideal option for peas and beans.",
      "PK VEG™":
        "Specifically formulated together with potassium to promote strong root development and maintain healthy plant growth in vegetable and salad crops.",

      // Foliar Nutrients
      "Maize Raiser":
        "A concentrated liquid foliar fertiliser designed mainly for Maize and Cereals to provide rapid nutrient availability.",
      "Mn SUPER™":
        "A unique combination of soluble manganese, magnesium and zinc with nitrogen and sulphur for fast and effective treatment of deficiencies.",
      "Mag Plus™":
        "Essential magnesium supplement to optimise photosynthesis and energy production.",
      "ful-oN™":
        "Nitrogen, potassium with fulvic acid specially formulated as a foliar feed to improve plant nutrition status at key stages of crop development.",
      "Mn-Cu Plus™":
        "Mn-Cu Plus offers a convenient method of correcting manganese and copper deficiencies in the developing crop",
      "Foliar Boost™":
        "Foliar Boost represents a new development in the science of foliar nutrition, combining plant-available nitrogen and sulphur with key micronutrients manganese, magnesium, copper and zinc.",
      "Cu-Zin™":
        "As well as preventing deficiencies, Cu-Zin has been manufactured to maintain increased levels of copper and zinc in the plant for extended periods of growth",
      "Pro-K™":
        "Pro-K is formulated together with plant available potassium to supply this essential nutrient at key growth stages and improve transportation of nutrients within the plant. ",
      "Pro-Sul™":
        "Pro-Sul is formulated together with plant available Sulphur to supply this essential nutrient at key growth stages.",

      // Calcium Range
      "Pro-Cal™":
        "Pro-Cal™ is formulated with amide Nitrogen to provide a regulated and readily available source of Calcium in combination with key nutrients.",
      "Advocate™":
        "AdvoCate™ is a unique Calcium formulation combining key nutrients with bioactive agents to provide exceptional nutrient uptake and mobility.",
      "CaPITAL™":
        "CaPITAL™ is a new generation phosphite, containing high levels of soluble calcium together with the key nutrients, boron and zinc.",

      // Biostimulants
      "Stimplex®":
        "Natural seaweed extract providing hormones and nutrients to enhance plant stress tolerance.",
      "Toggle®":
        "A powerful biostimulant that improves nutrient utilization and crop uniformity.",

      // Seed Treatments
      "Start-uP® MAXX":
        "With the benefits of phosphite chemistry and  formulated with bioactive agents and a manganese-rich nutrient package to promote rapid establishment.",
      "Start-uP®":
        "A powerful multi-nutrient phosphite crop nutrient formulated to boost root and shoot development and stimulate healthy growth.",
      "ProZest™":
        "ProZest™ is a powder or liquid formulation of zinc, sulphur and calcium, for application to potatoes at planting to prevent and correct many nutrition-related disorders and improve yield potential.",
      "Man-uP™":
        "To protect cereals from early deficiency problems, Man-uP™ provides a highly plant-available source of manganese to the germinating seed.",
      ...
      // Organic Range
      "Complete™ (6-2-4)":
        "Complete™ (6-2-4) is our most versatile analysis to provide the most rounded blend in the range.",
      "Complete Hi-Fruit™ (4-2-6)":
        "Complete Hi-Fruit™ (4-2-6) offers higher potassium content for situations where conditions may restrict full crop maturity or fruit development.",
      "K-Max™ (3-1-8)":
        "K-Max (3-1-8) offers the highest analysis of organically sourced potassium in liquid form.",
      "N-Max™ (7-2-2)":
        "N-Max™ (7-2-2) offers the highest analysis of organically sourced nitrogen in liquid form.",
      "Ultimate Gold™ (8-7-7)":
        "Ultimate Gold™ (8-7-7)* is a very high quality suspension of blended fish extracts. It is specifically for use in protected cropping situations.",
    ...
    switch (normalizedLink) {
      case "phosphite-range":
        return [
          ...
          <span key="p2">
            The <b>Ilex Phosphite Range</b> delivers essential nutrients quickly
            and effectively, consistently promoting strong root development.
          </span>,
      ...
      case "foliar-nutrients":
        return [
          ...
          <span key="p2">
            The <b>Ilex Foliar Nutrients Range</b> is designed for easy
            application across a wide range of arable and horticultural crops,
            ensuring consistent growth and health.
          </span>,
      ...
      case "calcium-range":
        return [
          ...
          <span key="p2">
            The <b>Ilex Calcium Supplement Range</b> delivers essential calcium
            efficiently, supporting optimal fruit and vegetable development from
      ...
      case "biostimulants":
        return [
          ...
          <span key="p2">
            The <b>Ilex Biostimulant Range</b> provides essential compounds to
            support plant vigour and resilience across diverse crops.
          </span>,
      ...
      case "seed-treatments":
        return [
          ...
          <span key="p2">
            The <b>Ilex Seed Treatment Range</b> delivers essential nutrients
            and protection for seedlings to ensure strong establishment.
          </span>,
      ...
      case "water-conditioners":
        return [
          ...
          <span key="p2">
            The <b>Ilex Water Conditioner Range</b> ensures uniform nutrient
            delivery and maximises the performance of foliar sprays.
          </span>,
      ...
      case "organic-range":
        return [
          ...
          <span key="p2">
            The <b>Ilex Organic Fertiliser Range</b> supports sustainable
            farming practices and promotes healthy, productive crops.
          </span>,
      ...
      default:
        return [
          "Premium agricultural solutions designed to enhance crop performance and quality.",
        ];
    }
  };
  ...
  const getProductImage = (productName: string) => {
    const productImageMap: { [key: string]: string } = {
      ...
      // Foliar Nutrients
      "Maize Raiser": "/assets/product images/Foliar/maize-raiser.jpg?v=1",
    ...
    return (
      ...
      "/assets/product images/Phosphite/Maniphos.jpg"
    );
  };
                  ...
                  <CardHeader className="!pt-0">
                    <CardTitle
                      ...
                      dangerouslySetInnerHTML={{
                        __html: `<strong>${product.product}</strong>`,
                      }}
                    />
