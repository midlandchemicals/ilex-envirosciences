...
export function CategoryPage({ category, onPageChange }: CategoryPageProps) {
  ...
  const getCategoryDescription = (link: string) => {
    switch (link) {
      case "phosphite-range":
        return "Phosphite technology enhances foliar nutrition by improving nutrient uptake, stimulating root growth, and helping crops withstand stress from weather and nutrient imbalances."
