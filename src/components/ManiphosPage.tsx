...
export function ManiphosPage({ onSubmit }: ContactFormProps) {
  ...
  const pdfLinks = [
    {
      ...
      url: "https://vutnh4xhalqycq9w.public.blob.vercel-storage.com/7.%20Maniphos%E2%84%A2/Maniphos%E2%84%A2%20Leaflet.pdf",
    },

    {
      title: "Phosphite Action Information Sheet",
      description: "Technical information about phosphite mode of action",
      url: "https://vutnh4xhalqycq9w.public.blob.vercel-storage.com/7.%20Maniphos%E2%84%A2/Phosphite%20Action%20Information%20Sheet.pdf",
    },
    {
      title: "Compatibility Chart",
      description: "Tank mixing compatibility with other agricultural products",
      url: "https://vutnh4xhalqycq9w.public.blob.vercel-storage.com/7.%20Maniphos%E2%84%A2/Compatibility%20Chart.pdf",
    },
  ];
  ...
  const showcaseData = {
    ...
    scientificBenefits: [
      ...
      },
      {
        ...
        description:
          "Rapid uptake and systemic movement ensures immediate manganese availability",
        icon: <Zap className="h-6 w-6 text-green-600" />,
      },
      {
        title: "Enzyme Activation",
        description:
          "Critical for over 30 enzyme systems involved in plant metabolism",
        icon: <Atom className="h-6 w-6 text-blue-600" />,
      },
      {
        title: "Chlorophyll Synthesis",
        description:
          "Essential for chlorophyll formation and photosystem II function",
  ...
  return (
    <div className="min-h-screen mt-10 bg-[#6abf4b]/20">
      {/* Hero Section */}
      <motion.section
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div {...fadeInUp}>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                The phosphite delivery system ensures rapid uptake and immediate
                plant response when deficiency symptoms appear, delivering
                targeted manganese nutrition when your crop needs it most.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <motion.div className="text-center mb-16" variants={fadeInUp}>
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover why Maniphos™ delivers superior manganese nutrition with
      ...
      <AnalysisPieChart
        ...
        title="Maniphos™ Nutrient Analysis"
      />
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Essential for oxygen evolution in photosystem II and
                          chlorophyll synthesis for optimal photosynthetic
                          efficiency.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Critical for over 30 enzyme systems involved in
                          respiration, metabolism, and antioxidant defense
                          mechanisms.
                        </p>
                      </div>
                    </div>
