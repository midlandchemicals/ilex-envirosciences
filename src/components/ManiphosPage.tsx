  ...
  const pdfLinks = [
    {
      ...
      url: "https://ilex-envirosciences.com/wp-content/uploads/2021/08/Maniphos-2003-i.pdf",
    },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div {...fadeInUp}>
              ...
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                A specialized manganese treatment enhanced with proven phosphite
                technology. Designed to prevent and correct manganese
              ...
              <CardContent className="p-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-green-50 rounded-lg">
                    ...
                    <p className="text-gray-600">
                      Ideal for targeted manganese applications and trial use
                    </p>
                  </div>
                  <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-green-50 rounded-lg">
                    <Badge
                    ...
                    <p className="text-gray-600">
                      Cost-effective solution for large-scale manganese
                      nutrition programs
                    </p>
                  </div>
                </div>
