...
export function ProSulPage({ onSubmit }: ContactFormProps) {
  ...
  const benefits = [
    {
      ...
      description: "Provides essential sulfur nutrition for protein synthesis and oil quality enhancement"
    },
    {
      icon: <Zap className="h-8 w-8 text-green-600" />,
      title: "Rapid Plant Uptake",
      description: "Fast-acting formulation ensures immediate sulfur availability when crops need it most"
    },
    {
      icon: <Target className="h-8 w-8 text-blue-600" />,
      title: "Protein & Oil Quality",
      description: "Essential for amino acid synthesis and oil quality improvement in oilseed crops"
    },
    {
      icon: <Activity className="h-8 w-8 text-purple-600" />,
      title: "Enhanced Metabolism",
      description: "Supports chlorophyll formation and enzyme activation for optimal plant function"
    },
    {
      icon: <Shield className="h-8 w-8 text-cyan-600" />,
      title: "Stress Tolerance",
      description: "Improves plant ability to cope with environmental stresses and disease pressure"
    },
    {
      icon: <Award className="h-8 w-8 text-orange-600" />,
      title: "Broad Crop Compatibility",
      description: "Effective across a wide range of crops including cereals, oilseeds, and vegetables"
    }
  ];
  ...
  const cropApplications = [
    {
      crop: "Cereals",
      stages: [
        { stage: "Tillering to stem extension", rate: "2-3 l/ha", notes: "Early sulfur support" },
        { stage: "Flag leaf emergence", rate: "2-3 l/ha", notes: "Grain quality enhancement" }
      ],
    ...
    },
    {
      crop: "Oilseed Rape",
      stages: [
        { stage: "Rosette to stem extension", rate: "3-4 l/ha", notes: "Oil quality improvement" },
        { stage: "Pre-flowering", rate: "2-3 l/ha", notes: "Seed development support" }
      ],
    ...
    },
    {
      crop: "Vegetables",
      stages: [
        { stage: "Early development", rate: "2-3 l/ha", notes: "Quality enhancement" },
        { stage: "Pre-harvest", rate: "2-3 l/ha", notes: "Nutritional quality boost" }
      ],
    ...
    },
    {
      crop: "Legumes",
      stages: [
        { stage: "Early flowering", rate: "2-3 l/ha", notes: "Protein synthesis support" },
        { stage: "Pod development", rate: "2-3 l/ha", notes: "Quality optimization" }
      ],
  ...
  const showcaseData = {
    productName: "Pro-Sul™",
    productDescription: "A premium sulfur foliar fertilizer designed to prevent and correct sulfur deficiencies while supporting essential plant functions. Essential for protein synthesis, oil quality, and overall crop performance. Formulated for rapid uptake and immediate plant response.",
    keyFeatures: [
    ...
    scientificBenefits: [
      {
        ...
        description: "Essential for amino acid formation and protein quality in grains and seeds",
        icon: <Atom className="h-6 w-6 text-yellow-600" />
      },
      {
        title: "Oil Quality Enhancement",
        description: "Critical for oil formation and quality characteristics in oilseed crops",
        icon: <Flame className="h-6 w-6 text-orange-600" />
      },
      {
        title: "Enzyme Activation",
        description: "Required for numerous enzyme systems and metabolic processes",
        icon: <Zap className="h-6 w-6 text-green-600" />
      },
      {
        title: "Chlorophyll Formation",
        description: "Essential for chlorophyll synthesis and photosynthetic efficiency",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-white to-orange-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div {...fadeInUp}>
              ...
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                A premium sulfur foliar fertilizer designed to prevent and correct sulfur deficiencies 
                while supporting essential plant functions. Essential for protein synthesis, oil quality, 
                and overall crop performance across a wide range of agricultural applications.
              </p>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Formulated for rapid uptake and immediate plant response, Pro-Sul™ delivers critical 
                sulfur nutrition when your crops need it most for optimal quality and yield development.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <motion.div className="text-center mb-16" variants={fadeInUp}>
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover why Pro-Sul™ delivers essential sulfur nutrition for superior crop quality
            </p>
          </motion.div>
      ...
      {/* Analysis Pie Chart */}
      <AnalysisPieChart analysis={analysisData} title="Pro-Sul™ Nutrient Analysis" />
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-6">Sulfur Nutrition Technology</h2>
            <p className="text-xl text-gray-600">
              Understanding the critical role of sulfur in crop quality and performance
            </p>
          </div>
              ...
              <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl">
                <CardContent className="p-8">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-2xl font-semibold">Essential Sulfur Functions</h3>
                  </div>
                  <div className="space-y-6">
                    <div className="flex items-start gap-3">
                      <Atom className="h-6 w-6 text-yellow-600 mt-1" />
                      <div>
                        <h4 className="font-semibold mb-2">Protein Synthesis</h4>
                        <p className="text-gray-600">
                          Essential for amino acid formation, particularly cysteine and methionine, 
                          crucial for protein quality in grains and seeds.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold mb-2">Oil Quality Enhancement</h4>
                        <p className="text-gray-600">
                          Critical for oil formation and quality characteristics in oilseed crops, 
                          affecting both quantity and nutritional value.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          ...
                          including nitrogen metabolism and stress resistance.
                        </p>
                      </div>
                    </div>
                    
                    <div className="bg-yellow-50 rounded-lg p-4">
                      <h4 className="font-semibold text-yellow-800 mb-2">Enhanced Formula</h4>
                      <p className="text-yellow-700">
                        Pro-Sul™ includes nitrogen, potassium, and magnesium to support 
                        optimal sulfur utilization and plant function.
                      </p>
                    </div>
                  </div>
                </CardContent>
            ...
            <Card className="bg-orange-50 border border-orange-200">
              <CardContent className="p-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-2 text-orange-800">Deficiency Treatment</h3>
                    <p className="text-orange-700">
                      For severe sulfur deficiencies, apply at the higher rate and repeat after 
                      2-3 weeks if symptoms persist. Monitor plant response closely.
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="text-center p-6 bg-gradient-to-br from-yellow-50 to-orange-50 rounded-lg">
                    ...
                    <p className="text-gray-600">Perfect for sulfur nutrition programs and quality enhancement</p>
                  </div>
                  <div className="text-center p-6 bg-gradient-to-br from-yellow-50 to-orange-50 rounded-lg">
                    <Badge variant="secondary" className="text-xl px-4 py-2 mb-4">1000L IBC</Badge>
                    <p className="text-gray-600">Cost-effective solution for large-scale sulfur nutrition</p>
                  </div>
                </div>
              </CardContent>
            </Card>
      ...
      {/* PDF Links Section */}
      <PDFLinks productName="Pro-Sul™" links={pdfLinks} />
