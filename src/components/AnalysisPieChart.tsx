...
export function AnalysisPieChart({
  ...
  const [animatedData, setAnimatedData] = useState<Charts[]>([]);
  ...
  const CustomTooltip = ({
    ...
    active?: boolean;
    payload?: { payload: Charts; value: number }[];
  }) => {
              ...
              <CardContent>
                ...
                <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                  <p className="text-sm text-blue-800">
                    <strong>Note:</strong> Percentages shown represent the
                    concentration by weight/volume (w/v) of each nutrient in the
                    formulation.
                  </p>
                </div>
              </CardContent>
