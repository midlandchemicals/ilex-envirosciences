...
export function FulOnPage({ onSubmit }: ContactFormProps) {
  ...
  const benefits = [
    {
      ...
      description: "Highly concentrated nitrogen solution for maximum nutrient delivery efficiency"
    },
    {
      icon: <TreePine className="h-8 w-8 text-blue-600" />,
      title: "Fulvic Acid Boost",
      description: "Natural fulvic acid enhances nutrient uptake and plant metabolism"
    },
    {
      icon: <Target className="h-8 w-8 text-purple-600" />,
      title: "Effective at Low Application Rates",
      description: "High concentration allows for cost-effective low-rate applications"
    },
    {
      icon: <Droplets className="h-8 w-8 text-cyan-600" />,
      title: "Dissolves Completely",
      description: "Formulated for complete tank dissolution with no residue or blockages"
    },
    {
      icon: <Activity className="h-8 w-8 text-orange-600" />,
      title: "Protein Enhancement",
      description: "Special application for milling wheats to enhance grain protein content"
    },
    {
      icon: <Award className="h-8 w-8 text-yellow-600" />,
      title: "Multi-Crop Benefits",
      description: "Improves quality and yields in wheats, potatoes, and oilseed rape"
    }
  ];
  ...
  const cropApplications = [
    {
      crop: "Cereals",
      stages: [
        { stage: "G.S. 23-30", rate: "5-10 l/ha", notes: "Early growth support" },
    ...
    },
    {
      crop: "Milling Wheat",
      stages: [
        { stage: "G.S. 69-71", rate: "20 l/ha", notes: "Grain protein enhancement" }
      ],
    ...
    },
    {
      crop: "Potatoes",
      stages: [
        { stage: "Early bulking", rate: "5-10 l/ha", notes: "Tuber development" },
        { stage: "During bulking", rate: "5-10 l/ha", notes: "Aid photosynthesis" }
      ],
    ...
    },
    {
      crop: "Oilseed Rape",
      stages: [
        { stage: "At/prior to rapid growth", rate: "5-10 l/ha", notes: "Growth support" },
        { stage: "Pre-flowering", rate: "3-5 l/ha", notes: "Quality enhancement" }
      ],
    ...
    scientificBenefits: [
      {
        ...
        description: "Minimum 50% of nitrogen in controlled-release polymethylene urea form",
        icon: <Atom className="h-6 w-6 text-green-600" />
      },
      {
        title: "Fulvic Acid Enhancement",
        description: "Natural fulvic acid boosts nutrient uptake and plant metabolism",
        icon: <TreePine className="h-6 w-6 text-blue-600" />
      },
      {
        title: "Dual Nitrogen System",
        description: "Combines rapid and extended nitrogen release for sustained nutrition",
        icon: <Zap className="h-6 w-6 text-purple-600" />
      },
      {
        title: "Protein Enhancement",
        description: "Specialized applications for grain protein improvement in wheat",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div {...fadeInUp}>
              ...
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                A highly concentrated solution of nitrogen, potassium with fulvic acid specially formulated as a 
                foliar feed to improve plant nutrition status at key stages of crop development. Contains nitrogen 
                and potassium in different forms to ensure both rapid plant availability together with extended nutrition.
              </p>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                The fulvic acid is a naturally occurring material with a specific structure, derived from humified, 
                carbon-rich organic matter, purified to maximize biological activity and enhance nutrient uptake.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <motion.div className="text-center mb-16" variants={fadeInUp}>
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover why ful-oN™ delivers superior nitrogen nutrition with fulvic acid enhancement
            </p>
          </motion.div>
      ...
      {/* Analysis Pie Chart */}
      <AnalysisPieChart analysis={analysisData} title="ful-oN™ Composition Analysis" />
              ...
              <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl">
                <CardContent className="p-8">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-2xl font-semibold">Natural Fulvic Acid Enhancement</h3>
                  </div>
                  <div className="space-y-6">
                    <div className="flex items-start gap-3">
                      <FlaskConical className="h-6 w-6 text-blue-600 mt-1" />
                      <div>
                        <h4 className="font-semibold mb-2">Organic Matter Origin</h4>
                        <p className="text-gray-600">
                          Derived from humified, carbon-rich organic matter and purified to 
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Fulvic acid acts as a natural chelator, improving nutrient 
                          availability and plant uptake efficiency.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Stimulates plant metabolism and enzyme activity for enhanced 
                    ...
                    <div className="bg-green-50 rounded-lg p-4">
                      <h4 className="font-semibold text-green-800 mb-2">Polymethylene Urea</h4>
                      <p className="text-green-700">
                        Minimum 50% of nitrogen in controlled-release polymethylene urea form 
                        for extended nutrition supply.
                      </p>
                    </div>
                  </div>
                </CardContent>
            ...
            <Card className="bg-amber-50 border border-amber-200">
              <CardContent className="p-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-2 text-amber-800">Protein Enhancement</h3>
                    <p className="text-amber-700">
                      For milling wheat protein enhancement, apply 20 l/ha at G.S. 69-71 (end of flowering 
                      to medium milk stage) to achieve premium protein specifications.
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="text-center p-6 bg-gradient-to-br from-green-50 to-blue-50 rounded-lg">
                    ...
                    <p className="text-gray-600">Ideal for most farming operations and flexible application programs</p>
                  </div>
                  <div className="text-center p-6 bg-gradient-to-br from-green-50 to-blue-50 rounded-lg">
      ...
      {/* PDF Links Section */}
      <PDFLinks productName="ful-oN™" links={pdfLinks} />
