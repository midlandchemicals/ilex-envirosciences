...
import img from "../../public/ful-on-img.jpg";
  ...
  const pdfLinks = [
    {
      ...
      url: "https://margdwcgeanpawjvnvqf.supabase.co/storage/v1/object/public/Ilex/ful-on/ful-oN-0323i.pdf",
    },
    {
      title: "Compatibility Chart",
      description: "Tank mixing compatibility with other agricultural products",
      url: "https://margdwcgeanpawjvnvqf.supabase.co/storage/v1/object/public/Ilex/ful-on/Compatibility-Chart-0923-ii.pdf",
    },
  ];
