...
export function OilSeedRaiserPage({ onSubmit }: ContactFormProps) {
  ...
  const benefits = [
    {
      ...
      description: "Specifically formulated to meet the unique nutritional demands of oilseed rape crops"
    },
    {
      icon: <Zap className="h-8 w-8 text-blue-600" />,
      title: "Enhanced Oil Content",
      description: "Promotes oil synthesis and quality for premium marketable yields"
    },
    {
    ...
    },
    {
      ...
      description: "Enhances plant resilience and survival through challenging winter conditions"
    },
    {
      icon: <Award className="h-8 w-8 text-orange-600" />,
      title: "Proven Performance",
      description: "Field-tested formulation delivering consistent results across UK conditions"
    },
    {
  ...
  const pdfLinks = [
    {
      ...
      description: "Complete product information and application guidelines for oilseed rape"
    },
    {
      title: "Oilseed Rape Nutrition Guide",
      description: "Comprehensive guide to oilseed rape nutritional requirements"
    },
    {
  ...
  const showcaseData = {
    ...
    productDescription: "A specialist foliar nutrition solution specifically formulated for oilseed rape. Designed to support critical growth stages from autumn establishment through to harvest, delivering the precise nutrients needed for premium oil content and maximum yields.",
    keyFeatures: [
    ...
    scientificBenefits: [
      {
        title: "Oil Synthesis",
        description: "Specialized nutrients support oil formation and quality development",
        icon: <Sunrise className="h-6 w-6 text-yellow-600" />
      },
      {
        title: "Winter Hardiness",
        description: "Strengthens plant resilience for better winter survival rates", 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-white to-blue-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div {...fadeInUp}>
              ...
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                A specialist foliar nutrition solution specifically formulated for oilseed rape. Designed to support 
                critical growth stages from autumn establishment through to harvest, delivering the precise nutrients 
                needed for premium oil content and maximum yields.
              </p>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Enhanced with essential macro and micronutrients tailored to oilseed rape requirements, 
                OilSeed Raiser™ delivers targeted nutrition when your crop needs it most.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <motion.div className="text-center mb-16" variants={fadeInUp}>
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover why OilSeed Raiser™ delivers superior nutrition specifically for oilseed rape
            </p>
          </motion.div>
      ...
      {/* Analysis Pie Chart */}
      <AnalysisPieChart analysis={analysisData} title="OilSeed Raiser™ Nutrient Analysis" />
              ...
              <CardContent className="p-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="text-center p-6 bg-gradient-to-br from-yellow-50 to-blue-50 rounded-lg">
                    ...
                    <p className="text-gray-600">Perfect for oilseed rape specialist nutrition programs</p>
                  </div>
                  <div className="text-center p-6 bg-gradient-to-br from-yellow-50 to-blue-50 rounded-lg">
                    <Badge variant="secondary" className="text-xl px-4 py-2 mb-4">1000L IBC</Badge>
                    <p className="text-gray-600">Cost-effective solution for large-scale oilseed rape production</p>
                  </div>
                </div>
              </CardContent>
            </Card>
      ...
      {/* PDF Links Section */}
      <PDFLinks productName="OilSeed Raiser™" links={pdfLinks} />
