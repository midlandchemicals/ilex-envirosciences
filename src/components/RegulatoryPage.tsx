...
//import ebicLogo from 'figma:asset/ebic-logo.png';
//import pbsgLogo from 'figma:asset/99a6297c9421b7174bd6d8db1d389e1a45f5da5e.png';
const ebicLogo = "https://example.com/ebic-logo.png"; // Replace with actual URL
const pbsgLogo = "https://example.com/pbsg-logo.png"; // Replace with actual URL
import {
  Globe,
  Leaf,
  TrendingUp,
